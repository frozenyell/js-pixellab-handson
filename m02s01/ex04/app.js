// avem nevoie de o clasa car care atunci cand este instantiata si se ruleaza metoda .render()
// sa afiseze in DOM masinuta cu proprietatile sspecificate
// pozitia (top left) color pentru culoare
...
class Car {
  ...
  move(left, top) {
    ...
    if (!isNaN(positionX)) {
      this.frame.style.left = positionY + 'px';
