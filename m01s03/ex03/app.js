...
Person si Larry (si invers).
`);

delete person.friends.larry;
delete larry.friends.friends;

console.warn(`
Afiseaza numele complet al lui Person folosind
obiectul Larry.
`);
console.log(
...
console.warn(`Afiseaza numele complet al lui Larry
folosind obiectul Person.`);
console.log(
...
console.warn(
  `Afiseaza numele complet inversat al lui Person
