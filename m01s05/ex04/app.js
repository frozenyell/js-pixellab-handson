...
const longWall1Surgface = calculateRectangleArea(6, 2.5);
...
const Total1Surface =
  longWall1Surgface * 2 + shortWall1Surface * 2 - door1Surface - window1Surface;

console.log(`Suprafata de tapet necesar este: ${Total1Surface} metri patrati.`);
